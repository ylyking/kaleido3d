...
set PLATFORM=Win64
set CONFIG=Debug
set BUILD_DIR=%~dp0\Intermediate\%PLATFORM%_UWP_%CONFIG%
...
cmake -G"Visual Studio 15 2017 %PLATFORM%" -H%SOURCE_DIR% -B%BUILD_DIR% -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 -DCMAKE_BUILD_TYPE=%CONFIG% -DBUILD_WITH_EDITOR=%BUILD_EDITOR% -Dgtest_force_shared_crt=OFF
