...
public:
    ...
    CharPosition        FindFirstNotOf(ThisString const& _Str);
    CharPosition        FindLastOf(BaseChar _BaseChar);
    CharPosition        FindLastNotOf(BaseChar _BaseChar);
    CharPosition        FindLastNotOf(ThisString const& _Str);
    CharPosition        Find(ConstCharPointer _Str, CharPosition StartPos = 0, CaseOption Opt = CaseSensitive);
    ThisString          SubStr(CharPosition _Start, CharPosition _Length);
...
template <typename BaseChar, typename Allocator>
KFORCE_INLINE BaseChar& StringBase<BaseChar, Allocator>::operator[](uint64 id)
{
    return m_pStringData[id];
}
...
template <typename BaseChar, typename Allocator>
KFORCE_INLINE typename StringBase<BaseChar, Allocator>::CharPosition
StringBase<BaseChar, Allocator>::FindFirstNotOf(ThisString const& _Str)
{
    CharPosition p = 0;
...
template <typename BaseChar, typename Allocator>
KFORCE_INLINE typename StringBase<BaseChar, Allocator>::CharPosition
StringBase<BaseChar, Allocator>::FindLastNotOf(ThisString const& _Str)
{
    CharPosition p = m_StringLength - 1;
    while (p != StringBase<BaseChar, Allocator>::npos
        && p >= 0)
...
template <typename BaseChar, typename Allocator>
KFORCE_INLINE typename StringBase<BaseChar, Allocator>::CharPosition
StringBase<BaseChar, Allocator>::FindLastOf(BaseChar _BaseChar)
{
    CharPosition p = m_StringLength - 1;
    while (p != StringBase<BaseChar, Allocator>::npos
        && p >= 0)
...
StringBase<BaseChar, Allocator>::SubStr(
    ...
    typename StringBase<BaseChar, Allocator>::CharPosition _Length)
{
