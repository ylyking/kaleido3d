...
namespace shaderlab
{
    ...
    Material::Material() : m_ActivePass(0), m_IsInRuntime(false), m_GfxBackend(ngfx::Backend::OpenGLES3)
    {
    }
    ...
    void MetaShader::CompileEntry(ngfx::Backend backend)
    {
        ...
        EntrySh stages[] = {
            { m_VertexEntry.c_str(),    ShaderStageBit::Vertex },
            { m_FragmentEntry.c_str(),  ShaderStageBit::Fragment },
            { m_GeometryEntry.c_str(),  ShaderStageBit::Geometry },
        };
