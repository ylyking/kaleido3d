...
namespace shaderlab
{
    ...
    std::string CodeNode::GetEntryFunction(ngfx::ShaderStageBit shaderStage)
    {
        switch (shaderStage)
        {
        case ngfx::ShaderStageBit::Vertex:
        case ngfx::ShaderStageBit::Fragment:
        case ngfx::ShaderStageBit::Geometry:
        case ngfx::ShaderStageBit::TessailationControl:
        case ngfx::ShaderStageBit::TessailationEval:
        default:
            break;
        }
        return "";
