...
K3D_COMMON_NS
{
K3D_API int Vsnprintf(char*dest, int n, const char* fmt, va_list list)
{
...
K3D_API String Base64Decode(String const& encoded_string)
{
...
K3D_API String MD5Encode(String const& in)
{
	MD5 md5;
	md5.Update(in);
	return md5.Str();
